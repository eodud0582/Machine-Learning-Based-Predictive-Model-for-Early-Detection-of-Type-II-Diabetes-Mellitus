...
![image](https://user-images.githubusercontent.com/38115693/155297510-fa226043-9174-4a03-8064-267d9c084351.png)

- 종속변수인 labels별(당뇨병 진단을 받은 경우 1, 아닌 경우 0) 각 피처의 분포도 확인 결과, HbA1c, FBG 등 **혈당 관련 수치는 당뇨병 진단을 받은 집단이 좀 더 높은 값에 분포**해 있다.
...
- 이상치/극단치가 존재하지만, 조사 결과, **이러한 수치들 또한 의미가 있다고 판단하여 제거하지 않고 그대로 사용**했다.
...
- 고령화가 심화되면서 당뇨병 환자의 수는 증가하고 있고, 코로나19로 인해 당뇨병에 대한 위험 요인 또한 늘어났다. 무엇보다 당뇨병 환자들은 큰 위협을 받고 있다. 이 코로나 시대에 모두 경각심을 갖고 **당뇨병 리스크를 사전에 파악하고, 이에 따른 당뇨병 자가 관리를 해 나가는 것이 그 어느 때 보다 필요**하다.
